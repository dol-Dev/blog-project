...
import { Container, Divider, GridColumn, Icon, Item, Message, Pagination } from 'semantic-ui-react';
...
const SearchPost = () => {
    ...
    useEffect(() => {
        const fetchPosts = async (page) => {
            try {
                const response = await axiosInstance.get(`/api/posts/search?page=${page}`, {
                    params: {
